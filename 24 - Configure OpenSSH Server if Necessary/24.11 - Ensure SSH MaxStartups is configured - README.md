## 1. If found, delete the line which contains 'MaxStartups'
    $ sudo LC_ALL=C sed -i "/^\s*MaxStartups\s\+/Id" /etc/ssh/sshd_config
...
## 4. Insert at the beginning of the file
    $ sudo echo "MaxStartups 10:30:60" | sudo tee /etc/ssh/sshd_config
